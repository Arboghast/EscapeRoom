...
public class CSVReader {
	...
	public static void main(String[] args) {
		...
		// Run this line of code after you run the game, if you put it before running
		// the game there will be no data to write into CSV
		// tracker.writeToCSV(Parameter 1 is a String, Parameter 2 is an Int, Parameter
		// 3 is an Int);

		// Testing the getRowData function, should return an arrayList of all strings
		// with row information
	...
	public ArrayList<String> getRowData() {
		ArrayList<String> rowData = new ArrayList<String>();  //Returns CSV data combined into a string
		...
		for (int i = 0; i < (this.CSVData.size() - 3) / 4; i++) {
			...
			rowData.add("Player " + name + " has completed the game in " + minutes + " minutes and " + seconds
					+ " seconds.");
		}
		return rowData;
	}
